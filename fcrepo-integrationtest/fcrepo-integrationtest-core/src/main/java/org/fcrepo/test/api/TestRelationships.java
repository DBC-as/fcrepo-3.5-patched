...
public class TestRelationships
    ...
    public void testGetAllRelationships() throws Exception {
        // subject uri and pid
        List<org.fcrepo.server.types.mtom.gen.RelationshipTuple> tuples = apim.getRelationships("demo:777", null);
    ...
    private void checkExistsViaGetRelationships(String subject,
        ...
        for (org.fcrepo.server.types.mtom.gen.RelationshipTuple tuple : apim
    ...
    private void getRelationship(String subject,
        ...
        List<org.fcrepo.server.types.mtom.gen.RelationshipTuple> tuples = apim.getRelationships(subject, predicate);
